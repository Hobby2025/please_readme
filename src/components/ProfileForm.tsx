...
export default function ProfileForm({ profile, setProfile }: ProfileFormProps) {
  ...
  return (
    <div className="h-full">
      <div className="border-b border-gray-200 dark:border-gray-700 bg-[#8B5CF6]/10 dark:bg-[#8B5CF6]/20 px-6 py-4 rounded-t-xl">
      ...
      <div className="p-6 space-y-5">
        ...
        <div className="space-y-1">
          ...
          <div className="relative mt-1">
            ...
            <input
              ...
              className="shadow-sm focus:ring-[#8B5CF6] focus:border-[#8B5CF6] block w-full pl-10 pr-3 py-2 sm:text-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white rounded-lg"
              required
            />
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative flex mt-1">
            ...
            <input
              ...
              className="shadow-sm focus:ring-[#8B5CF6] focus:border-[#8B5CF6] block w-full pl-10 pr-3 py-2 sm:text-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white rounded-l-lg"
              onKeyDown={(e) => {
                if (e.key === 'Enter') {
                  e.preventDefault();
                  handleAddSkill(e);
            ...
            <button
              ...
              className="inline-flex items-center justify-center px-4 py-2 border border-transparent text-xs font-medium rounded-r-lg shadow-sm text-white bg-[#8B5CF6] hover:bg-[#7C3AED] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8B5CF6] transition-colors"
            >
              추가
            </button>
          </div>
        ...
        <div className="pt-2">
          ...
          <div className="grid grid-cols-2 gap-4 mt-1">
            <label className={`relative flex p-3 bg-white dark:bg-gray-900 border rounded-lg cursor-pointer transition ${profile.theme === 'light' ? 'border-[#8B5CF6] ring-2 ring-[#8B5CF6]/20 dark:ring-[#8B5CF6]/30' : 'border-gray-300 dark:border-gray-700'}`}>
              <input
                type="radio"
                name="theme"
                value="light"
            ...
            <label className={`relative flex p-3 bg-white dark:bg-gray-900 border rounded-lg cursor-pointer transition ${profile.theme === 'dark' ? 'border-[#8B5CF6] ring-2 ring-[#8B5CF6]/20 dark:ring-[#8B5CF6]/30' : 'border-gray-300 dark:border-gray-700'}`}>
              <input
                type="radio"
                name="theme"
                value="dark"
